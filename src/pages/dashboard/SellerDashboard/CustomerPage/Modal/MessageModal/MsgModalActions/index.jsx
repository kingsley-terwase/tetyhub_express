...
/**
 * @param {{ onCancel:()=>void, onSend:()=>void, loading:boolean, channel:string }} props
 */
export function MessageModalActions({ onCancel, onSend, loading, channel }) {
  ...
  return (
    <>
      ...
      >
        <SendRegular fontSize={15} color="#fff" style={{ display: "block" }} />
